...
public class TP7 extends Configured implements Tool {
  ...
  public static class TP7Reducer extends Reducer<Text,TaggedValue,Text,Text> {
	...
	//yarn jar tp7-mapreduce-0.0.1.jar /user/bfaltrep/cities.txt /user/bfaltrep/region.txt  /user/bfaltrep/tp7
  public static void main(String[] args) throws Exception {
	  int res = ToolRunner.run(new TP7(), args);
	  System.exit(res);
  }
}
